...
public class TileSelector : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(player._characterController.isGrounded && Vector2.Distance(new Vector2(transform.position.x, transform.position.z), new Vector2(player.tileUnder.transform.position.x, player.tileUnder.transform.position.z)) < 2.4f)
        {

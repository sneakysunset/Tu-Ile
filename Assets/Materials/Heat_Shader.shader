	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target 
			{
				...
				float2 texCoord65 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_0 = (( _Laser_Speed * _Time.y )).xx;
				float simplePerlin2D71 = snoise( temp_cast_0*_Disto_Scale );
				simplePerlin2D71 = simplePerlin2D71*0.5 + 0.5;
				float4 color78 = IsGammaSpace() ? float4(1,0.2446993,0,1) : float4(1,0.04877978,0,1);
				
				float fresnelNdotV55 = dot( WorldNormal, worldViewDir );
				float fresnelNode55 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV55, _Fresnel_Power ) );
				
				o.Albedo = ( ( tex2D( _TextureSample0, texCoord65 ) * simplePerlin2D71 ) * color78 ).rgb;
				o.Normal = fixed3( 0, 0, 1 );
				o.Emission = ( fresnelNode55 * _Color0 ).rgb;
				#if defined(_SPECULAR_SETUP)
...
/*ASEBEGIN
Version=18935
0;0;1536;795;459.1804;419.1987;1.717127;True;True
Node;AmplifyShaderEditor.SimpleTimeNode;27;-808.4689,-435.3969;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;69;886.8984,77.48675;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;71;209.3675,-207.7609;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;70;620.8511,-243.6863;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;60;51.54102,906.4556;Inherit;False;Property;_Color0;Color 0;4;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;1.059274,0.03327561,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-31.62501,-156.9501;Inherit;False;Property;_Disto_Scale;Disto_Scale;2;0;Create;True;0;0;0;False;0;False;10;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-381.8542,568.2864;Inherit;False;Property;_Fresnel_Power;Fresnel_Power;3;1;[HDR];Create;True;0;0;0;False;0;False;10;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-754.805,-600.9028;Inherit;False;Property;_Laser_Speed;Laser_Speed;5;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=42D043AC74EF40BDC220DE695FAD28B52AB86F5A